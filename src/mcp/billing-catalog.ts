...
export function formatBillingCatalog(): string {
  ...
  return [
    ...
    '',
    'How to get access',
    'Free: add the hosted MCP server to your agent. No registration and no API key.',
    'Pro or Ultra: open the Plans page on the AGNT website: /plans',
    '1. Choose Pro or Ultra.',
    '2. Enter your email and create an MPP/crypto payment quote.',
    '3. Pay the exact quoted amount.',
    '4. Paste the transaction hash on the page.',
    '5. After verification, the page shows your API key once.',
    '',
